...
ADMINS = [("""Q Technology""", "noreply@bookingbalkans.com.tr")]
...
# Social login providers. Credentials are read from environment variables so
# they never need to be committed to the repository.
